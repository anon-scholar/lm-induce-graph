...
connection_dict = run_algorithm_for_each_clique_size(connection_proxy_graph, seed=42)
# print(connection_dict)
print()
# Print the results
for degree, result in connection_dict.items():
    print(f"clique size {degree}:")
...
tot_connection_per_sample = range(1, 10)
        ...
        for ent_con in tot_ent_con:
            ...
            for id, sampled_list_item in enumerate(dispersed_sampled_list):
                try:
                    ...
                    score, full_metric = calculate_score_v3(true_adj_matrix, predicted_adj_matrix)
            ...
            if len(metrics) > 0:
                ...
                with open('output/full_results_clique_at.jsonl', 'a') as f:
...
with open('output/full_results_clique_at.json', 'w') as f:
